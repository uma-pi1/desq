...
public class DesqCountWithPruningIcdm16Test extends Icdm16TraditionalMiningTest {
    public DesqCountWithPruningIcdm16Test(long sigma, int gamma, int lambda, boolean generalize) {
