 ...
 */
public class PrefixGrowthMinerTest extends TestWithTemporaryFolder {
    @Test
    public void icdm() throws IOException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        MinerTestUtils.mineIcdm16Example(PrefixGrowthMiner.class, actualFile,
                PrefixGrowthMiner.createProperties(sigma, gamma, lambda, generalize));
