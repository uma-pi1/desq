...
public class Token extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Token\",\"namespace\":\"avroschema\",\"fields\":[{\"name\":\"pos\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]},{\"name\":\"ner\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]},{\"name\":\"span\",\"type\":{\"type\":\"record\",\"name\":\"Span\",\"fields\":[{\"name\":\"start_index\",\"type\":[\"int\",\"null\"]},{\"name\":\"end_index\",\"type\":[\"int\",\"null\"]}]}},{\"name\":\"lemma\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]},{\"name\":\"word\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]},{\"name\":\"index\",\"type\":[\"int\",\"null\"]}]}");
   ...
   */
  public Token(java.lang.String pos, java.lang.String ner, Span span, java.lang.String lemma, java.lang.String word, java.lang.Integer index) {
    this.pos = pos;
    this.ner = ner;
    this.span = span;
    this.lemma = lemma;
  ...
  public static Token.Builder newBuilder(Token.Builder other) {
    return new Token.Builder(other);
  }

  /** Creates a new Token RecordBuilder by copying an existing Token instance */
  public static Token.Builder newBuilder(Token other) {
    return new Token.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Token>
    ...
    private Builder(Token.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'pos' field */
    public Token.Builder setPos(java.lang.String value) {
    ...
    /** Sets the value of the 'ner' field */
    public Token.Builder setNer(java.lang.String value) {
    ...
    /** Sets the value of the 'span' field */
    public Token.Builder setSpan(Span value) {
    ...
    public Token.Builder clearSpan() {
      span = null;
    ...
    /** Sets the value of the 'lemma' field */
    public Token.Builder setLemma(java.lang.String value) {
    ...
    public Token.Builder clearLemma() {
      lemma = null;
    ...
    /** Sets the value of the 'word' field */
    public Token.Builder setWord(java.lang.String value) {
    ...
    public Token.Builder clearWord() {
      word = null;
    ...
    /** Sets the value of the 'index' field */
    public Token.Builder setIndex(java.lang.Integer value) {
    ...
    public Token.Builder clearIndex() {
      index = null;
    ...
    public Token build() {
      try {
        ...
        record.span = fieldSetFlags()[2] ? this.span : (Span) defaultValue(fields()[2]);
