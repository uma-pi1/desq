...
public class Span extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Span\",\"namespace\":\"avroschema\",\"fields\":[{\"name\":\"start_index\",\"type\":[\"int\",\"null\"]},{\"name\":\"end_index\",\"type\":[\"int\",\"null\"]}]}");
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Span>
    ...
    private Builder(Span.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'start_index' field */
    public Span.Builder setStartIndex(java.lang.Integer value) {
    ...
    public Span.Builder clearStartIndex() {
      start_index = null;
    ...
    /** Sets the value of the 'end_index' field */
    public Span.Builder setEndIndex(java.lang.Integer value) {
    ...
    public Span.Builder clearEndIndex() {
      end_index = null;
