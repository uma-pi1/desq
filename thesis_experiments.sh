...
# mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DMC --patexp=\"(DT JJ+? NN NN?)\" --limit=200000 --sigma=10 --parts=256 --from=2003/01/01 --to=2003/12/31 --q1=\"George W. Bush\" --q2=\"John Kerry\"  --data=data-local/processed/es_all_v1 --out=data-local/processed/es_eval/pattern --index=nyt_v1 --section=true"
# mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DMC --patexp=\"(DT JJ+? NN NN?)\" --limit=200000 --sigma=10 --parts=256 --from=2004/01/01 --to=2004/12/31 --q1=\"George W. Bush\" --q2=\"John Kerry\"  --data=data-local/processed/es_all_v1 --out=data-local/processed/es_eval/pattern --index=nyt_v1 --section=true"
# mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DMC --patexp=\"(DT JJ+? NN NN?)\" --limit=200000 --sigma=10 --parts=256 --from=2005/01/01 --to=2005/12/31 --q1=\"George W. Bush\" --q2=\"John Kerry\"  --data=data-local/processed/es_all_v1 --out=data-local/processed/es_eval/pattern --index=nyt_v1 --section=true"

# mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DMC --patexp=\"(DT JJ+? NN NN?)\" --limit=200000 --sigma=10 --parts=256 --from=1998/01/01 --to=2007/12/31 --q1=\"David Beckham\" --q2=\"Hillary Clinton\"  --data=data-local/processed/es_all_v1 --out=data-local/processed/es_eval/pattern --index=nyt_v1 --section=true"
