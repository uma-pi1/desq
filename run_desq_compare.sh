...
for j in 1 2 3 4 ; do
 set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"ENTITY (VB+ NN+? IN?) ENTITY\" --limit=50000 --sigma=10 --parts=128"
done

for j in 1 2 3 4 ; do
 set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(ENTITY^ VB+ NN+? IN? ENTITY^)\" --sigma=100 --limit=50000 --parts=128"
done

for j in 1 2 3 4 ; do
 set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(ENTITY^ be@VB=^) DT? (RB? JJ? NN)\" --sigma=10 --limit=50000 --parts=128"
done

for j in 1 2 3 4 ; do
 set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(.^){3} NN\" --sigma=1000 --limit=50000 --parts=128"
done

for j in 1 2 3 4 ; do
set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"([.^ . .]|[. .^ .]|[. . .^])\" --sigma=1000 --parts=128 --limit=50000"
done
...
for j in 1 2 3 4 ; do
set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(ENTITY VB+ NN+? IN? ENTITY)\" --sigma=5 --parts=128 --limit=50000
...
for j in 1 2 3 4 ; do
set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(ENTITY VB+ NN+? IN? ENTITY)\" --sigma=5 --parts=128 --limit=50000 --from=1987/01/01 --to=1998/12/31"
done

for j in 1 2 3 4 ; do
set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(ENTITY VB+ NN+? IN? ENTITY)\" --sigma=5 --parts=128 --limit=50000 --from=1987/01/01 --to=2003/12/31"
done

for j in 1 2 3 4 ; do
set MAVEN_OPTS=-Xms8192m -Xmx8192m -Xss8m & mvn compile && mvn exec:java -Dexec.mainClass="de.uni_mannheim.desq.examples.spark.DesqCompareExample" -Dexec.args="--master=local[*] --algo=DC --patexp=\"(ENTITY VB+ NN+? IN? ENTITY)\" --sigma=5 --parts=128 --limit=50000 --from=1987/01/01 --to=2007/12/31"
done
